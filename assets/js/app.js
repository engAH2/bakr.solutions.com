(function () {
  ...
  function renderChrome() {
      ...
      <div class="header-inner">
        <div class="logo">
          <a class="logo-main" href="${ROOT}index.html">
            <img src="${ROOT}assets/images/logo.svg" alt="شعار ركن العطاء" width="46" height="46">
          </a>
          <div class="logo-text">
            ...
            <a class="founder-link" href="${B.founder.url}" target="_blank" rel="noopener">المؤسس: ${B.founder.name}</a>
          </div>
        </div>
    ...
    footer.innerHTML = `
      <div class="container footer-grid">
        <div>
          <strong>${B.name}</strong>
          <div>للخدمات الطلابية</div>
          <p>${B.description}</p>
          <a class="founder-link founder-link-footer" href="${B.founder.url}" target="_blank" rel="noopener">المؤسس: ${B.founder.name}</a>
          <small class="founder-role">${B.founder.title}</small>
          <a href="${B.founder.youtubeChannel}" target="_blank" rel="noopener">قناة يوتيوب</a>
        ...
        <div>
          ...
          <a href="${ROOT}pages/about.html#founder">المؤسس</a>
        ...
        <div>
          ...
          <a href="${B.whatsappUrl}" target="_blank" rel="noopener">واتساب</a>
          <a href="mailto:${B.email}">${B.email}</a>
          <a href="${ROOT}pages/privacy.html">سياسة الخصوصية</a>
          <a href="${ROOT}pages/terms.html">الشروط والأحكام</a>
        </div>
      </div>
      <div class="container footer-bottom">© ${B.year} ${B.fullName} — تأسيس وإشراف تقني: <a href="${B.founder.url}" target="_blank" rel="noopener">${B.founder.name}</a></div>
    `;
  ...
  function bindCarousel(root) {
    ...
    const goTo = (n) => {
      ...
      root._scrollTimer = window.setTimeout(paintDots, 450);
    };
    ...
    root.addEventListener("click", (e) => {
      ...
      if (btn && root.contains(btn)) goTo(page() + Number(btn.dataset.dir));
    ...
    viewport.addEventListener(
      ...
      () => {
        ...
        root._dotTimer = window.setTimeout(paintDots, 80);
      },
      { passive: true }
    );
  ...
  function assistant() {
    ...
    if (welcomeNotice && !welcomeNotice.classList.contains("is-hidden")) {
      ...
      window.setTimeout(hideWelcome, 12000);
    }
...
الرسالة: ${form.message.value}`;
  ...
  function seoHead() {
    ...
    const image = new URL(ROOT + "assets/images/logo.svg", location.origin).href;
    ...
    themeMeta.setAttribute("content", dark ? "#0a1413" : "#0c6b64");
      ...
      l.href = ROOT + "assets/images/logo.svg";
      return l;
    });
